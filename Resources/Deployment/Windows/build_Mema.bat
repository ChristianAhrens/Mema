...
if "%VSVER%"=="VS2022" (
    ...
    set BUILDSLN=%WORKSPACE%\Builds\VisualStudio2022\Mema.sln
) else (
    ...
    set BUILDSLN=%WORKSPACE%\Builds\VisualStudio2026\Mema.sln
)
...
"%PROJUCERVSDIR%\x64\Release\App\Projucer.exe" --resave %WORKSPACE%\Mema.jucer --fix-missing-dependencies
echo.
